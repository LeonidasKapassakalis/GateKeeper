inherited DMPrnTransEmp: TDMPrnTransEmp
  OldCreateOrder = True
  ...
  object qryACard: TADOQuery
    ...
    Prepared = True
    SQL.Strings = (
      'SELECT  [ACARDID] ,[ACARDCODE] ,[REGNO] ,[AcardCodeFull]'
      ' FROM VACard Where EMPLOYEESID > 0')
    Left = 44
    Top = 96
  ...
  object qryEmployees: TADOQuery
    ...
    Left = 44
    Top = 184
    object qryEmployeesId: TIntegerField
      FieldName = 'Id'
      ReadOnly = True
    end
    ...
    object qryEmployeesFName: TStringField
