...
type
  TrptKinhs5 = class(TrptBaseAvinCard)
    QRGroup2: TQRGroup;
    QRDBText8: TQRDBText;
    QRBand2: TQRBand;
    QRDBText4: TQRDBText;
...
procedure TrptKinhs5.qryTranCalcFields(DataSet: TDataSet);
begin
...
procedure TrptKinhs5.QRExpr2Print(sender: TObject; var Value: String);
begin
  Value := format('%m', [(strtofloat(Value))]);
end;

procedure TrptKinhs5.QRExpr3Print(sender: TObject; var Value: String);
begin
  Value := format('%f', [(strtofloat(Value))]);
end;

procedure TrptKinhs5.QRExpr1Print(sender: TObject; var Value: String);
begin
  Value := format('%m', [(strtofloat(Value))]);
end;

procedure TrptKinhs5.QRLabel8Print(sender: TObject; var Value: String);
begin
  inherited;
