...
uses
  ...
  Dialogs, RBaseAvinCard, QRCtrls, DB, ADODB, QuickRpt, ExtCtrls, QRExport,
  QRWebFilt, QRPDFFilt, QRXMLSFilt;

type
  TrptAcardGrComp = class(TrptBaseAvinCard)
    ADOQuery1: TADOQuery;
...
var
  rptAcardGrComp: TrptAcardGrComp;
...
procedure TrptAcardGrComp.ADOQuery1CalcFields(DataSet: TDataSet);
begin
  inherited;
