inherited frmBRPersons: TfrmBRPersons
  Caption = #917#954#964#973#960#969#963#951' '#917#960#953#963#954#949#960#964#974#957
  ...
  inherited cxGrid1: TcxGrid
    inherited cxGrid1DBTableView1: TcxGridDBTableView
      ...
      object cxGrid1DBTableView1ContactId: TcxGridDBColumn
    ...
    object cxGrid1DBTableView2: TcxGridDBTableView [1]
      ...
      object cxGrid1DBTableView2ContactId: TcxGridDBColumn
        DataBinding.FieldName = 'ContactId'
      end
      object cxGrid1DBTableView2DTime: TcxGridDBColumn
        DataBinding.FieldName = 'DTime'
      end
      object cxGrid1DBTableView2MinDiff: TcxGridDBColumn
        DataBinding.FieldName = 'MinDiff'
      end
    end
    object cxGrid1DBTableView3: TcxGridDBTableView [2]
      ...
      DataController.DataSource = dtsMain1
      DataController.DetailKeyFieldNames = 'id'
      DataController.Summary.DefaultGroupSummaryItems = <>
      DataController.Summary.FooterSummaryItems = <>
      DataController.Summary.SummaryGroups = <>
  ...
  inherited qryMain: TADOQuery
    ...
    object qryMainIdentityNo: TWideStringField
    ...
    object qryMainContactWith: TWideStringField
    ...
    object qryMainAir_Lift: TBooleanField
      FieldName = 'Air_Lift'
    end
