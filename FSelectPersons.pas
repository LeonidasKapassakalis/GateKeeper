...
type
  TfrmSelectPersons = class(TfrmBaseDev0)
    ...
    fnHelpPersonIdentityNo: TWideStringField;
    fnHelpPersonContactWith: TWideStringField;
...
procedure TfrmSelectPersons.cxGrid1DBTableView1DblClick(Sender: TObject);
begin
  inherited;
  ModalResult := mrOk;
  // Close;
...
procedure TfrmSelectPersons.cxGrid1Enter(Sender: TObject);
begin
  inherited;
  Self.ModalResult := mrCancel;
end;

procedure TfrmSelectPersons.FormCreate(Sender: TObject);
var
  x: Integer;
begin
  inherited;
