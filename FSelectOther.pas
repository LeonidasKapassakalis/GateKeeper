...
type
  TfrmSelectOther = class(TfrmBaseDev0)
...
procedure TfrmSelectOther.cxGrid1DBTableView1DblClick(Sender: TObject);
begin
  inherited;
  ModalResult := mrOk;
  // Close;
...
procedure TfrmSelectOther.cxGrid1Enter(Sender: TObject);
begin
  inherited;
  Self.ModalResult := mrCancel;
end;

procedure TfrmSelectOther.FormCreate(Sender: TObject);
var
  x: Integer;
begin
  inherited;
