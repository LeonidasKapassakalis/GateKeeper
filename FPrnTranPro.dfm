inherited frmPrnTranPrologue: TfrmPrnTranPrologue
  Left = 366
  Top = 198
  BorderIcons = []
  Caption = #922#961#953#964#942#961#953#945' '#949#954#964#973#960#969#963#951#962' '#954#953#957#942#963#949#969#957
  ClientHeight = 433
  ClientWidth = 659
  OldCreateOrder = True
  ...
  object PageControl1: TPageControl [1]
    ...
    object TabSheet2: TTabSheet
      ...
      object cblc20: TcxDBLookupComboBox
        ...
        Properties.ListSource = DMPrnTrans.dtsCustomer
        TabOrder = 0
    ...
    object TabSheet4: TTabSheet
      ...
      object FEnhmDaily: TcxDBLookupComboBox
        ...
        Properties.ListSource = DMPrnTrans.dtsEnhmDlCall
        TabOrder = 1
        OnKeyDown = cblcKeyDown
        Width = 145
      end
      ...
      object FEnhmPela: TcxDBLookupComboBox
        ...
        Properties.ListSource = DMPrnTrans.dtsENHMPECALL
        TabOrder = 4
        OnKeyDown = cblcKeyDown
        Width = 145
      end
      object FEnhmStath: TcxDBLookupComboBox
        ...
        Properties.ListSource = DMPrnTrans.dtsENHMSTCALL
        TabOrder = 7
        OnKeyDown = cblcKeyDown
        Width = 145
      end
      object FEnhmCom: TcxDBLookupComboBox
        ...
        Properties.ListSource = DMPrnTrans.dtsENHMCOCALL
        TabOrder = 10
        OnKeyDown = cblcKeyDown
        Width = 145
      end
      object FEnhmDisc: TcxDBLookupComboBox
        ...
        Properties.ListSource = DMPrnTrans.dtsENHMDISCALL
    ...
    object TabSheet8: TTabSheet
      ...
      object cblcAcard: TcxDBLookupComboBox
        ...
        Properties.ListSource = DMPrnTrans.dtsACard
        TabOrder = 0
        OnKeyDown = cblcKeyDown
        Width = 177
      end
      ...
      object cblc2: TcxDBLookupComboBox
        ...
        Properties.ListSource = DMPrnTrans.dtsTrCallDate
        TabOrder = 5
        OnKeyDown = cblcKeyDown
        Width = 145
      end
      ...
      object cxDBLookupComboBox1: TcxDBLookupComboBox
        Left = 88
        Top = 245
        DataBinding.DataField = 'AcardGroup'
        DataBinding.DataSource = dsmemWS
        Properties.Alignment.Horz = taLeftJustify
        Properties.DropDownAutoSize = True
        Properties.KeyFieldNames = 'AcardGroupId'
        Properties.ListColumns = <
          item
            FieldName = 'Descr'
          end>
        Properties.ListSource = DMPrnTrans.dtsAcardGroupMain
        TabOrder = 7
        OnKeyDown = cblcKeyDown
        Width = 177
      end
      object cxDBLookupComboBox2: TcxDBLookupComboBox
        Left = 88
        Top = 293
        DataBinding.DataField = 'ACardRNGroup'
        DataBinding.DataSource = dsmemWS
        Properties.Alignment.Horz = taLeftJustify
        Properties.DropDownAutoSize = True
        Properties.KeyFieldNames = 'AcardRNGroupId'
        Properties.ListColumns = <
          item
            FieldName = 'Descr'
          end>
        Properties.ListSource = DMPrnTrans.dtsAcardRNGroupMain
        TabOrder = 8
        OnKeyDown = cblcKeyDown
        Width = 177
      end
  ...
  inherited memWS: TdxMemData
    ...
    object memWSFrDate: TDateField
      FieldName = 'FrDate'
      OnValidate = memWSFrDateValidate
    end
    object memWSToDate: TDateField
      FieldName = 'ToDate'
      OnValidate = memWSToDateValidate
    end
    ...
    object memWSFrCustomer: TStringField
      ...
      OnValidate = memWSFrCustomerValidate
      Size = 100
    end
    object memWSToCustomer: TStringField
      DisplayWidth = 50
      FieldName = 'ToCustomerName'
      OnValidate = memWSToCustomerValidate
      Size = 100
    end
    ...
    object memWSAcardGroup: TIntegerField
      Tag = 999
      FieldName = 'AcardGroup'
    end
    object memWSACardRNGroup: TIntegerField
      FieldName = 'ACardRNGroup'
    end
  end
  object dxBarManager1: TActionManager [6]
    ActionBars = <
      item
        Items = <
          item
